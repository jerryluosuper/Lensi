...
LastEditTime: 2022-03-13 13:58:02
...
def choco_install_gitee():
    ...
    choco_install_gitee.write("mkdir D:\Choco_all" + "/n"+ "$env:ChocolateyInstall='D:\Choco_all'"+"[Environment]::SetEnvironmentVariable('ChocolateyInstall', $env:ChocolateyInstall, 'User')"+"/n"+"git clone 'https://gitee.com/mirrors/chocolatey.git'" +"\n"+ "cd .\chocolatey\ " + "\n" + "sudo ./setup.ps1")
...
print(choco_info(choco_search("geek")[0]))